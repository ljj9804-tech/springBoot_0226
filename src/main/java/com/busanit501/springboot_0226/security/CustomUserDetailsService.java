package com.busanit501.springboot_0226.security;
...
import com.busanit501.springboot_0226.security.dto.MemberSecurityDTO;
...
//                .build();
        ...
        Optional<SpringMember> result = memberRepository.getWithRoles(username);
        if(result.isEmpty()){
            throw new UsernameNotFoundException("해당 유저가 없습니다. ");
        }
        SpringMember member = result.get();
